  ...
  return (
    ...
    >
      <div className="w-full flex justify-between item-center max-w-7xl mx-auto">
       ...
       >
          <img src={logo} alt="logo" className="w-10 h-7 object-contain" />
          <p className='text-white text-[18px] font-bold cursor-pointer'>Akshar| Portfolio</p>
        ...
        <ul className='list-none flex sm:flex justify-end items-start flex-col gap-4 '>{navLinks.map((link)=>(
          <li
          key={link.id}
          className={`${active === link.id ? "text-white" : "text-secondary"}
