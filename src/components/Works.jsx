...
<div className="w-full flex">
  ...
  of my work . Each project is briefly described with a link to the code repositories and live demos in it. It reflects my ability to solve complex problems, work with different tecnologies and manage projects effectively.
   </motion.p> </div>
